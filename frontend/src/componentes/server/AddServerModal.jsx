...
// Importa o CSS do AccountModal para reutilizar estilos de backdrop e input
...
const AddServerModal = ({ show, onClose, onSaveServer }) => {
    ...
    const handleSubmit = (e) => {
        ...
        // Gera um ID seguro para ser usado no nome do arquivo (ex: "Novo PW" -> "novo_pw")
    ...
    return (
        // Usando classes de backdrop/dialog do AccountModal.css
        // O zIndex é mantido inline apenas para garantir a precedência sobre o AccountModal (1050)
            ...
            <div className="account-modal-dialog modal-dialog-centered" style={{margin: '10rem auto', maxWidth: '400px'}}> 
                <div className="account-modal-content">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="modal-body p-4 bg-dark text-light">
                            
                            <div className="mb-3">
                                <label className="form-label small text-light">Nome do Servidor*</label>
                                <input 
                                    type="text" 
                                    className="form-control form-control-custom-dark" /* Usando a classe do AccountModal.css */
                                    value={serverName}
